			...
			children: [/* @__PURE__ */ jsxs("header", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("section", {
						...
						}), /* @__PURE__ */ jsxs("ol", { children: [rows.map((r, i) => /* @__PURE__ */ jsxs("li", {
						...
						}, r.id)), rows.length === 0 && /* @__PURE__ */ jsx("li", {
					...
					/* @__PURE__ */ jsxs("section", {
						...
						}), /* @__PURE__ */ jsxs("ul", { children: [games.map((g) => {
							const mine = g.white_id === user.id ? "white" : "black";
						...
						}), games.length === 0 && /* @__PURE__ */ jsx("li", {
							className: "px-4 py-3 text-sm text-muted-foreground",
