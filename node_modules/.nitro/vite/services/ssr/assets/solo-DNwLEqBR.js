import { a as getBot, c as readAllElo, d as startElo, f as writeElo, i as evaluate, l as readElo, n as BOT_TIERS, o as nextElo, r as botMove, t as BOTS } from "./engine-BXikbV55.js";
import { a as BoardView, i as soundEnabled, o as BOARD_THEMES, r as setSoundEnabled, t as playMoveSound } from "./sounds-DLicoFiG.js";
...
function ChessBoard() {
	...
	const finished = !!over;
	const finish = useCallback((headline, detail, result) => {
	...
	if (!started) return /* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx(Group, {
						...
						children: SIDES.map((s) => /* @__PURE__ */ jsx(Choice, {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("p", {
							...
							children: BOT_TIERS.map((tier) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
								className: "mb-1.5 text-[11px] font-semibold uppercase tracking-wide text-muted-foreground",
								children: tier
							}), /* @__PURE__ */ jsx("div", {
								className: "grid grid-cols-2 gap-1.5",
								children: BOTS.filter((b) => b.tier === tier).map((b) => /* @__PURE__ */ jsxs("button", {
					...
					/* @__PURE__ */ jsx(Group, {
						...
						children: TIMERS.map((t) => /* @__PURE__ */ jsx(Choice, {
							active: minutes === t.id,
					...
					/* @__PURE__ */ jsx(Group, {
						...
						children: BOARD_THEMES.map((t) => /* @__PURE__ */ jsx(Choice, {
							active: theme === t.id,
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("span", { className: `size-2.5 rounded-full ${thinking ? "bg-accent" : "bg-primary"} animate-pulse` }), /* @__PURE__ */ jsx("p", {
			...
			/* @__PURE__ */ jsx(GameOverDialog, {
				...
				extra: eloDelta !== null ? /* @__PURE__ */ jsxs("p", {
...
//#endregion
//#region src/routes/solo.tsx?tsr-split=component
function Solo() {
