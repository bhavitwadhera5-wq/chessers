...
//#endregion
//#region src/components/BoardView.tsx
var GLYPHS = {
	k: "♚",
	q: "♛",
	r: "♜",
				...
				return /* @__PURE__ */ jsx("div", {
					...
					children: cells.map((cell, fIdx) => {
						...
						return /* @__PURE__ */ jsxs("button", {
							...
							children: [
								showCoords && fIdx === 0 && /* @__PURE__ */ jsx("span", {
								...
								showCoords && rIdx === rows.length - 1 && /* @__PURE__ */ jsx("span", {
								...
								isTarget && !cell && /* @__PURE__ */ jsx("span", {
...
//#endregion
export { BoardView as a, soundEnabled as i, playSound as n, BOARD_THEMES as o, setSoundEnabled as r, THEME_KEY as s, playMoveSound as t };
