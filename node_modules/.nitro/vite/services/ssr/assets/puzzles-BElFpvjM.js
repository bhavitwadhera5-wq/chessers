import { a as BoardView, n as playSound, o as BOARD_THEMES, s as THEME_KEY } from "./sounds-DLicoFiG.js";
import { useEffect, useMemo, useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { Chess } from "chess.js";
//#region src/lib/puzzles.ts
...
//#endregion
//#region src/routes/puzzles.tsx?tsr-split=component
function Puzzles() {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(BoardView, {
						...
						children: [
							...
							phase === "solving" && /* @__PURE__ */ jsx("button", {
							...
							phase === "failed" && /* @__PURE__ */ jsx("button", {
								onClick: retry,
								className: "rounded-lg border border-border px-3 py-2 text-sm font-medium text-foreground hover:bg-secondary",
								children: "Try again"
							}),
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("p", {
									...
									children: BOARD_THEMES.map((t) => /* @__PURE__ */ jsx("button", {
										onClick: () => {
											setTheme(t.id);
