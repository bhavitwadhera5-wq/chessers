...
import { n as Route, r as useAuth } from "./router-B_EKXhaC.js";
...
function OnlineGame() {
	...
	if (!game) return /* @__PURE__ */ jsx("main", {
	...
	return /* @__PURE__ */ jsxs("main", {
		...
		children: [showResult && /* @__PURE__ */ jsx("div", {
			...
			children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("span", {
								...
								children: [
									"You are",
									" ",
									/* @__PURE__ */ jsx("strong", { children: myColor === "w" ? "White" : myColor === "b" ? "Black" : "Spectator" })
								]
							}), /* @__PURE__ */ jsx("span", {
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsx("div", {
                        ...
                        `,
								children: [piece && /* @__PURE__ */ jsx("span", {
									className: `
                              relative
                              z-10
                              font-serif
                            ...
                            `,
								...
								}), selectedHere && /* @__PURE__ */ jsx("span", { className: "pointer-events-none absolute inset-1 rounded-lg border-4 border-yellow-400" })]
				...
				game.status === "playing" && /* @__PURE__ */ jsx("div", {
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: game.status === "waiting" ? /* @__PURE__ */ jsx("p", {
						className: "text-sm text-muted-foreground",
						children: "Waiting for another player to join..."
					}) : game.status === "finished" ? /* @__PURE__ */ jsx("p", {
						className: "font-bold",
						children: message
					}) : game.turn === myColor ? /* @__PURE__ */ jsx("p", {
						className: "font-bold",
