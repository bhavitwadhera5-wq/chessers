	...
	return /* @__PURE__ */ jsxs("form", {
		...
		children: [
			/* @__PURE__ */ jsx("div", {
				...
				children: ["in", "up"].map((m) => /* @__PURE__ */ jsx("button", {
					type: "button",
					onClick: () => {
						setMode(m);
						setError(null);
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			isAdmin && /* @__PURE__ */ jsxs("button", {
				...
				children: ["🛠️ Admin Console", /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsxs("button", {
				...
				children: ["🌐 Play Online", /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsxs("button", {
				...
				children: ["🤖 Play Against AI", /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("button", {
					...
					children: ["🧩 Chess Puzzles", /* @__PURE__ */ jsx("span", {
						className: "mt-1 block text-xs font-normal text-muted-foreground",
					...
					className: "rounded-xl border border-border px-4 py-4 text-left font-semibold transition-colors hover:bg-secondary",
					children: ["🏆 Leaderboard", /* @__PURE__ */ jsx("span", {
						className: "mt-1 block text-xs font-normal text-muted-foreground",
