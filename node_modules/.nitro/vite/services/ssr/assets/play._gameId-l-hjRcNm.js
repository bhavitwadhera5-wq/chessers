import { n as createServerFn } from "./server-BPEUc65i.js";
import { n as useServerFn, t as createSsrRpc } from "./createSsrRpc-y04ZF_dC.js";
import { t as requireSupabaseAuth } from "./auth-middleware-FXaLlSDC.js";
import { i as humanThinkDelay, n as humanBotByName, r as humanBotMove } from "./humanBots-Dol-gB05.js";
import { t as supabase } from "./client-BGr9uG5A.js";
import { n as Route, r as useAuth } from "./router-D_modgaU.js";
import { a as BoardView, o as BOARD_THEMES, s as THEME_KEY, t as playMoveSound } from "./sounds-DLicoFiG.js";
import { n as GameOverDialog, t as MoveList } from "./MoveList-DNL6uaMB.js";
...
//#endregion
//#region src/lib/moderation.functions.ts
var REPORT_REASONS = [
	{
		id: "cheating",
...
//#endregion
//#region src/components/ReportPanel.tsx
...
function ReportPanel({ gameId }) {
	...
	if (state === "done") return /* @__PURE__ */ jsx("p", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: REPORT_REASONS.map((r) => /* @__PURE__ */ jsx("button", {
...
//#endregion
//#region src/routes/play.$gameId.tsx?tsr-split=component
var BOT_WAIT_MS = 3e4;
var POLL_MS = 2e3;
function PlayOnline() {
	...
	const botThinkingRef = useRef(null);
	...
	if (!game) return /* @__PURE__ */ jsxs(Shell, { children: [/* @__PURE__ */ jsx("p", {
	...
	if (!myColor) return /* @__PURE__ */ jsx(Shell, { children: /* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsxs(Shell, { children: [/* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			game.status === "waiting" && /* @__PURE__ */ jsxs("div", {
			...
			botName && game.status === "active" && /* @__PURE__ */ jsx("div", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(BoardView, {
					board,
					selected,
					destinations,
					lastMove,
					...
					children: [
						...
						incomingDraw && game.status === "active" && /* @__PURE__ */ jsxs("div", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("p", {
								...
								className: "flex flex-wrap gap-1.5",
								children: BOARD_THEMES.map((boardTheme) => /* @__PURE__ */ jsx("button", {
						...
						game.status === "finished" && /* @__PURE__ */ jsx("button", {
		...
		whiteLabel: myColor === "w" ? username ?? "You" : opponentName ?? "White",
		blackLabel: myColor === "b" ? username ?? "You" : opponentName ?? "Black",
		reportSlot: /* @__PURE__ */ jsx(ReportPanel, { gameId }),
		onReview: (review) => {
			sendFairPlay({ data: {
				gameId,
				stats: ["w", "b"].map((color) => ({
