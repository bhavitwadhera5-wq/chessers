...
import { r as useAuth } from "./router-BZgWhZSc.js";
...
function PlayerAdmin() {
	...
	return /* @__PURE__ */ jsxs("section", { children: [
		...
		/* @__PURE__ */ jsxs("div", {
			className: "space-y-2",
			children: [!busy && players.length === 0 && /* @__PURE__ */ jsx("p", {
				className: "text-sm text-muted-foreground",
				children: "No players found."
			}), players.map((p) => /* @__PURE__ */ jsxs("article", {
...
function Admin() {
	...
	if (state === "loading") return /* @__PURE__ */ jsx("main", {
		className: "p-8 text-center text-muted-foreground",
		children: "Loading…"
	});
	if (state === "denied") return /* @__PURE__ */ jsxs("main", {
	...
	return /* @__PURE__ */ jsxs("main", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("section", { children: [/* @__PURE__ */ jsxs("h2", {
				...
				className: "space-y-3",
				children: [reports.length === 0 && /* @__PURE__ */ jsx("p", {
					className: "text-sm text-muted-foreground",
					children: "No reports filed yet."
				}), reports.map((r) => /* @__PURE__ */ jsxs("article", {
					className: "rounded-lg border border-border bg-card p-4",
					children: [/* @__PURE__ */ jsxs("div", {
						className: "flex flex-wrap items-center justify-between gap-2",
						children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("p", {
							className: "font-medium",
							children: [r.reported_username ?? r.reported_id ?? "Unknown player", /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsxs("section", { children: [/* @__PURE__ */ jsx("h2", {
				...
				children: /* @__PURE__ */ jsxs("table", {
					...
					}), /* @__PURE__ */ jsxs("tbody", { children: [flags.length === 0 && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", {
						className: "p-3 text-muted-foreground",
						colSpan: 5,
						children: "No analysed games yet."
					}) }), flags.map((f) => /* @__PURE__ */ jsxs("tr", {
