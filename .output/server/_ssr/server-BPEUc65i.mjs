...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DvsFmG9v.mjs");
...
var manifest = {
	"0c572b87d175c555742716bd49ec1623931b0f407c46a1261100fae63bce22e2": {
		...
		importer: () => import("./admin.functions-Bjsx08e2.mjs")
	},
	...
	"4729b461ab9e7f95edbc2066531e6119c7ef1c4ef291f5167be40c95b0ca16f9": {
		...
		importer: () => import("./games.functions-Bq7SPPzW.mjs")
	},
	...
	"c136811f6020ce02f020d92d8cabe7bf91cf5edfcdc0f55cfb280e27d76222b5": {
		...
		importer: () => import("./moderation.functions-DsJiitQl.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D_modgaU.mjs").then((n) => n.t),
