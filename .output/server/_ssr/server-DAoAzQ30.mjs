...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BFd5csuU.mjs");
...
var manifest = {
	"0c572b87d175c555742716bd49ec1623931b0f407c46a1261100fae63bce22e2": {
		...
		importer: () => import("./admin.functions-CkekCSKt.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B_EKXhaC.mjs").then((n) => n.t),
